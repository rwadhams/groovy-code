...
class SocialSecurityCalculatorApp2 {
	int firstAmt = 2047		//2023
	int secondAmt = 2519	//2023
	int thirdAmt = 2907		//2023
	
	static main(args) {
		println 'SocialSecurityCalculatorApp started...'
		println ''

		SocialSecurityCalculatorApp2 app = new SocialSecurityCalculatorApp2()
		app.execute()
	...
	def execute() {
		...
		YearMonth secondYM = YearMonth.of(2027,6)
		boolean secondTier = false
		int secondTotal = 0
		int secondCounter = 0
		boolean secondGreaterThanFirst = false
		
		YearMonth thirdYM = YearMonth.of(2029,6)
